...
public class WorldV6Tests
{
    ...
    {
        World world = WorldFactory.FromLocationData(_locationData);
    ...
    public void FromLocationData_ForComplexLocation_ShouldCreateWorldCorrectly()
    {
        ...
        Assert.Equal(["north"], vestibule.ConnectedDirections);
        Assert.Equal(["west", "east", "south"], new HashSet<string>(entranceHall.ConnectedDirections));
