...
// ## Beispiel
//
// - Modul `MyModule.cs` schreibt Daten in eine Datenbank
// - Datenfluss: von `MyModule.cs` zur Datenbank
// - Quellcode-Abhängigkeit: `MyModule.cs` hängt von der Datenbank (`Database.cs`) ab
...
// %%
Console.WriteLine(string.Join(", ", myDomainObjectV1.RetrieveResult()));
...
// %%
Console.WriteLine(string.Join(", ", myDomainObjectV2.RetrieveResult()));
